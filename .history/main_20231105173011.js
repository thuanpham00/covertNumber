...
window.addEventListener("load", function () {
    ...
    const icon = document.querySelector(".row__icon.icon-2 i");
    const output2 = document.querySelector(".output.output-2");
